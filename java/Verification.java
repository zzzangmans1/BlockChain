...
public class Verification {
	 ...
	 *  @Retun 검증 성공 여부
	 */
	public static boolean verfication(String signMessage, Key key) 
		...
		String checkHash = Sha256.encrypt(str[0]);
	 ...
	 *  @Return 서명
	 */
	public static String signature(String message, Key key) 
		...
		String messageHash = Sha256.encrypt(message);
